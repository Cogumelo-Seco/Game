            ...
            <body>
                <section>
                    ...
                    <div id="serverCreationWindow">
                        ...
                        <p>Tempo de jogo em minutos: <input type="number" className="serverCreationWindow-inputs gameTime" /> 1/10</p>
                        ...
                        <p>Quantidade de Bots: <input type="number" className="serverCreationWindow-inputs botCount" /> 0/40</p>
                        <p>Quantidade Máxima de players: <input type="number" className="serverCreationWindow-inputs maxPlayers" /> 5/50</p>
